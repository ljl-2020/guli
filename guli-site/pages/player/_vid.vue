<template>
  <div>
    ...
    <!-- 启用私有加密的防调式：生产环境使用 -->
    <script src="https://g.alicdn.com/de/prismplayer/2.9.6/aliplayer-min.js" />

    <!-- 阿里云视频播放器脚本 -->
    <script charset="utf-8" type="text/javascript" src="https://g.alicdn.com/de/prismplayer/2.9.6/aliplayer-min.js"/>
    <!-- 定义播放器dom -->
 ...
 */
  mounted() {
    ...
    new Aliplayer({
      ...
      vid: this.vid, // videoSourceId
      playauth: this.playAuth // 视频播放凭证
    }, function(player) {
      console.log('播放器创建成功')
    })
  }
