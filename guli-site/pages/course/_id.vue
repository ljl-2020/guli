          ...
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt of">
              <span class="ml10 vam">
                ...
                <a class="c-fff vam" title="收藏" href="javascript: void(0)" @click="saveCollect()">收藏</a>
              </span>
            </section>
  ...
  methods: {
    createOrder() {
      orderApi.createOrder(this.course.id).then(response => {
        this.$router.push({ path: '/order/' + response.data.orderId }) // 路由跳转
      })
    },
    saveCollect() {
      courseApi.save(this.course.id).then(response => {
        this.$message({
          type: 'success',
